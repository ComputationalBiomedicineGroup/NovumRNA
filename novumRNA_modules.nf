...
process 'OptiType' {
  ...
  reads = (meta.libType == "PE") ? fastq[0] + " " + fastq[1] : fastq
    ...
    if [ $HLA_types_I == "HLA_default.txt" ]; then
       ...
       python /usr/local/bioinf/optiType/latest/OptiTypePipeline.py -i "AK11_CRC01_mapped_1.bam" --rna -o . -v -c /home/ausserh/nc_na/HLA_II_typing/config.ini -p AK11_CRC01
    else
